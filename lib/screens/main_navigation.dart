    ...
    return BlocBuilder<AuthCubit, AuthState>(
      builder: (context, authState) {
        ...
        return BlocListener<AuthCubit, AuthState>(
          ...
          child: Builder(
            builder: (context) {
              // Trigger initialize if it's the first build after authentication
              if (context.read<AppCubit>().currentUserId == null && authState.user != null) {
                context.read<AppCubit>().initialize(authState.user!.uid);
              }
                ...
                body: BlocListener<AppCubit, AppState>(
                  listener: (context, appState) {
                    ...
                    if (appState.successMessage != null) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text(appState.successMessage!), backgroundColor: Colors.green),
                      );
                      context.read<AppCubit>().clearMessages();
                    }
                  },
